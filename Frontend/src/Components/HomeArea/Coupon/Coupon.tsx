...
function Coupon(): JSX.Element {
    ...
    // useState returns array containing the state value and the function to change the value: 
    const couponStateArray = useState<string>("");

    // Taking the state value: 
    const coupon = couponStateArray[0]; // state value
    ...
    return (
        <div className="Coupon Box">
            <p>
                ...
                <span>Item: {coupon}, Price: {price}</span>
            </p>
        </div>
    );
